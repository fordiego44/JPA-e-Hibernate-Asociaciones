package com.diego.curso.springboot.jpa.springboot_jpa_relationship;
...
import com.diego.curso.springboot.jpa.springboot_jpa_relationship.entities.Address;
import com.diego.curso.springboot.jpa.springboot_jpa_relationship.entities.Client;
import com.diego.curso.springboot.jpa.springboot_jpa_relationship.entities.ClientDetails;
import com.diego.curso.springboot.jpa.springboot_jpa_relationship.entities.Course;
import com.diego.curso.springboot.jpa.springboot_jpa_relationship.entities.Invoice;
import com.diego.curso.springboot.jpa.springboot_jpa_relationship.entities.Student;
import com.diego.curso.springboot.jpa.springboot_jpa_relationship.repositories.ClientDetailsRepository;
import com.diego.curso.springboot.jpa.springboot_jpa_relationship.repositories.ClientRepository;
import com.diego.curso.springboot.jpa.springboot_jpa_relationship.repositories.CourseRepository;
import com.diego.curso.springboot.jpa.springboot_jpa_relationship.repositories.InvoiceRepository;
import com.diego.curso.springboot.jpa.springboot_jpa_relationship.repositories.StudentRepository;
...
public class SpringbootJpaRelationshipApplication implements CommandLineRunner {
	...
	public void removeAddressFindById() {
		...
		optionalClient.ifPresent(client -> {
			...
			// System.out.println("clientRepository.save before: "+ client);
			Client savedClient = clientRepository.save(client);
			// System.out.println("clientRepository.save after: "+ clientRepository.save(client));
			System.out.println(client);
 
			Optional<Client> optionalClient2 = clientRepository.findOne(2L);
			optionalClient2.ifPresent(c -> { 
				c.getAddresses().remove(savedClient.getAddresses().stream().findFirst().orElse(null));
	...
	public void removeAddress() {
		...
		Address address1 = new Address("El verjel", 1234);
		System.out.println("address1 part1: "+address1);
		Address address2 = new Address("Vasco de Gama", 9875);
		
		client.getAddresses().add(address1);
		System.out.println("address1 part1.5: "+address1);
		...
		System.out.println("address1 part2: "+address1);
